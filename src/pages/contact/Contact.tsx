            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 md:col-span-2">
                  ...
                  <p className="text-slate-600 text-base leading-relaxed">Building # C-2C, Third Floor (Corner), Saadi Lane No. 1, Khayaban-e-Ittehad, Phase VII, DHA, Karachi 75500</p>
                </div>
