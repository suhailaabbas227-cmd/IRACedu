    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-brand-primary py-24 relative overflow-hidden">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Our Academic Services</h1>
          <p className="text-white/80 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            International Standard Research & Academic Consultancy (IRAC) provides a complete suite of services to support your scholarly success.
          </p>
        </div>
      </section>
            ...
            {services.map((service, i) => (
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-2xl font-bold text-brand-primary mb-4 group-hover:text-brand-secondary transition-colors">
                    {service.title}
                  </h3>
      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="text-lg font-bold text-brand-primary">Engr. Muhammad Ali Shaikh</div>
            <div className="text-slate-500 text-sm">Lead Research Consultant, IRAC</div>
          </div>
        </div>
      </section>
