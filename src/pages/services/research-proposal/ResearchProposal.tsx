  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="bg-brand-primary py-24 relative overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10 text-center">
          ...
          <p className="text-white/80 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            Crafting compelling research proposals that secure approvals and demonstrate methodological excellence.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100">
                <h3 className="text-xl font-bold text-brand-primary mb-4">Strategic Framework</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
                  A strong research proposal is the foundation of any successful Ph.D. or Master's journey. We help you articulate your research gap, objectives, and significance with absolute clarity.
                </p>
              </div>
              <div className="bg-brand-primary/5 p-8 rounded-2xl border border-brand-primary/10">
                <h3 className="text-xl font-bold text-brand-primary mb-4">Methodological Rigor</h3>
                <p className="text-slate-600 text-sm leading-relaxed">
      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10 text-center">
          <h2 className="text-3xl font-bold text-brand-primary mb-16">The IRAC Advantage</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
              ...
              <h4 className="font-bold text-brand-primary mb-3">Gap Discovery</h4>
              <p className="text-slate-500 text-sm">We help you identify unique research niche that adds value to the field.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
              ...
              <h4 className="font-bold text-brand-primary mb-3">Precision Writing</h4>
              <p className="text-slate-500 text-sm">Academic writing that is formal, precise, and logically structured.</p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
              <div className="w-12 h-12 bg-brand-primary/10 rounded-xl flex items-center justify-center mx-auto mb-6">
                <CheckCircle2 className="w-6 h-6 text-brand-primary" />
              </div>
              <h4 className="font-bold text-brand-primary mb-3">Expert Review</h4>
              <p className="text-slate-500 text-sm">Multiple rounds of internal review by Ph.D. scholars before delivery.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 text-center bg-white">
        <div className="max-w-3xl mx-auto px-6">
          <h3 className="text-2xl md:text-3xl font-bold text-brand-primary mb-8">Need Help with Your Proposal?</h3>
          <button 
