        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-slate-400 text-lg md:text-xl leading-relaxed">
              Developing valid and reliable research tools, surveys, and questionnaires tailored to your specific constructs and study population.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              <h2 className="text-3xl font-bold text-brand-primary mb-8 underline decoration-brand-secondary underline-offset-8">Our Rigorous Process</h2>
              <div className="space-y-12">
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-brand-primary mb-2">Construct Definition</h4>
                    <p className="text-slate-600">Clearly defining the variables and constructs your instrument intends to measure based on existing literature.</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-brand-primary mb-2">Item Generation</h4>
                    <p className="text-slate-600">Developing a comprehensive pool of items using appropriate scales (Likert, semantic differential, etc.).</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-brand-primary mb-2">Content Validity</h4>
                    <p className="text-slate-600">Subjecting the items to expert review (CVI) to ensure they accurately represent the construct.</p>
                  </div>
                </div>
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-brand-primary mb-2">Pilot Testing</h4>
                    <p className="text-slate-600">Running initial tests to assess reliability (Cronbach's Alpha) and refining items for clarity.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              <div className="p-8 bg-brand-primary/5 rounded-3xl border border-brand-primary/10">
                ...
                <h3 className="text-2xl font-bold text-brand-primary mb-4">Reliability & Validity</h3>
      ...
      <section className="bg-brand-secondary py-16">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="text-brand-primary">
            <h2 className="text-2xl md:text-3xl font-bold mb-2">Ensure Your Data is Accurate</h2>
            <p className="font-medium opacity-80">Get a professionally designed research instrument today.</p>
          </div>
          <button 
