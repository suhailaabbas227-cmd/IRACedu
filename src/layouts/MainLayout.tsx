      ...
      <footer className="bg-slate-900 text-white py-12">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12 border-b border-white/10 pb-12">
            <div>
              <h3 className="text-xl md:text-2xl font-bold mb-4 uppercase tracking-wider text-white">iracedu.com</h3>
          ...
          <div className="text-center text-slate-500 text-sm">
            <p>© {new Date().getFullYear()} iracedu.com. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
